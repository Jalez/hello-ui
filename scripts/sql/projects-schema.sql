...
CREATE TABLE IF NOT EXISTS game_instances (
  ...
  created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  updated_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
  CONSTRAINT game_instances_scope_targets_chk CHECK (
...
COMMENT ON TABLE game_instances IS 'Per-game runtime instances (individual or group) with scoped progress state';
