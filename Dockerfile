...
ARG NEXT_PUBLIC_WEBSOCKET_URL=http://localhost:3100
ARG NEXT_PUBLIC_WEBSOCKET_TRANSPORTS=websocket,polling
ARG NEXT_PUBLIC_ASSET_PREFIX=
ARG NEXT_PUBLIC_BASE_PATH=
ENV NEXT_PUBLIC_DRAWBOARD_URL=$NEXT_PUBLIC_DRAWBOARD_URL
ENV NEXT_PUBLIC_APP_URL=$NEXT_PUBLIC_APP_URL
ENV NEXT_PUBLIC_WEBSOCKET_URL=$NEXT_PUBLIC_WEBSOCKET_URL
ENV NEXT_PUBLIC_WEBSOCKET_TRANSPORTS=$NEXT_PUBLIC_WEBSOCKET_TRANSPORTS
